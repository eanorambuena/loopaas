    ...
    async function loadOrganizations() {
      try {
        ...
        if (userInfoError || !userInfo) {
          ...
          toast({
            title: tc('error'),
            description: tc('couldNotGetUserInfo'),
            variant: 'destructive'
          })
          return
        }
                  ...
                  <div className="p-6 pb-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span>
                          {t('createdOn')} {new Date(org.created_at).toLocaleDateString('es-ES', {
                            year: 'numeric',
                            month: 'short',
                            day: 'numeric'
                          })}
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span>
                          {org.coursesCount || 0} {org.coursesCount === 1 ? t('course') : t('courses')}
                        </span>
                      </div>
                    </div>
                  </div>
